...
class PostApiTestCase(TestCase):
  ...
  def setUp(self):
    ...
    posts = [
      ...
      # lookup for a post with a specific id 
  ...
  def test_post_list(self):
    resp = self.client.get("/api/v2/posts/")
    ...
    for post_dict in data:
      ...
      self.assertTrue(
        post_dict["author"].endswith(f"/api/v2/users/{post_obj.author.email}")
  ...
  def test_unauthenticated_post_create(self):
    ...
    post_dict = {
           "title": "Test Post",
            ...
            "author": "http://testserver/api/v2/users/test@example.com",
            "published_at": "2021-01-10T09:00:00Z",
            }
    resp=self.client.post("/api/v2/posts/",post_dict)
